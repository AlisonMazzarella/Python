...
def main():
    formula = input('Please enter the chemical formula for a molecule: ')
    mass_grams = float(input('Please enter the mass in grams: '))
    ...
    molarmass = mass_grams / molar_mass
    print(f"{molar_mass:.5f} grams/mole")
    print(f'{molarmass:.5f} moles')
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for element in symbol_quantity_list:
        ...
        mass = periodic_table_dict[symbol]
        atomic_mass = float(mass[1])
